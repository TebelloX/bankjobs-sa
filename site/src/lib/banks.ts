// Bank slugs for the per-bank landing pages. packages/core owns BRANDS (the 14
...
/** Slug for each of the 14 brands, e.g. { 'Standard Bank': 'standard-bank' }. */
...
/** Brand name for a slug, or undefined if the slug is not one of the fourteen. */
